...
export default function AppointmentDescriptorsPage() {
  ...
  const processedDescriptors = processDescriptors(data, selectedDescriptorType);
        ...
        <div className="bg-white shadow-sm border border-gray-200 rounded-lg overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <h2 className="text-lg font-semibold text-gray-900">
              {selectedDescriptorType === "all" ? "All Descriptors" : selectedDescriptorType} ({processedDescriptors.length})
            </h2>
