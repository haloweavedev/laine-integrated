...
# Add Tools to VAPI Assistant Script (Fixed JSON)
# Usage: ./add_tools_to_assistant_fixed.sh <vapi-token> <assistant-id> <app-base-url>
...
create_tool() {
    ...
    # Build the tool JSON payload with proper formatting
    local tool_payload
